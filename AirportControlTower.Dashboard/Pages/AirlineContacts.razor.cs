...
{
    public partial class AirlineContacts
    {
        #region fields + props
        IEnumerable<ListAirlineDto> listEntities = [];
        bool _isProcessing;
        ListAirlineDto? _airlineDetails;
        ...
        {
            CurrentSortField = nameof(ListAirlineDto.LastUpdate),
        ...
        async Task GetEntitiesAsync(CancellationToken cancellationToken = default)
        {
            ...
            PaginatedEntities<ListAirlineDto>? paged = await Service.AirlinesThatHaveMadeContactToControlTowerAsync(pagingOptions, cancellationToken);
